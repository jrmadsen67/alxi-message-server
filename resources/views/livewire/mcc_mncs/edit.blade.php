                ...
                <div class="">
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 relative">
                        ...
                        <div class="sm:col-span-1">
                            <label for="mcc" class="block text-sm font-medium text-gray-700">
                                MCC
                            </label>
                            <div class="mt-1">
                                <input  wire:model="mcc"
                                        type="text"
                                        name="mcc"
                                        id="mcc"
                                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                @error('mcc') <span class="error">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="mt-1">
                                <input  wire:model="mnc"
                                        type="text"
                                        name="mnc"
                                        id="mnc"
                                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                @error('mnc') <span class="error">{{ $message }}</span> @enderror
                            </div>
                        </div>
